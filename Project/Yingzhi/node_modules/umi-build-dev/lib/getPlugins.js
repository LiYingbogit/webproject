...
Try:
  ...
  const builtInPlugins = ['./plugins/output-path', './plugins/global-js', './plugins/global-css', './plugins/antd', './plugins/fastclick', './plugins/hd', './plugins/proxy', ...(process.env.MOCK === 'none' ? [] : ['./plugins/mock']), './plugins/hash-history', './plugins/afwebpack-config', './plugins/404'];
