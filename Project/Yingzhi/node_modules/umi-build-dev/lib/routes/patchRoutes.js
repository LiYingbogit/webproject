...
var _default = (routes, config = {}, isProduction) => {
  redirects = [];
...
function patchRoutes(routes, config, isProduction) {
  ...
  const removedRoutes = (0, _lodash.default)(routes, route => {
...
function patchRoute(route, config, isProduction) {
  ...
  if (route.meta && route.meta.Route) {
    (0, _deprecate.default)('route.meta.Route is deprecated, use route.Route instead');
